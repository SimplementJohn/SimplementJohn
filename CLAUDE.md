# SimplementJohn — GitHub Profile README

## Structure

Single file: `README.md` — GitHub profile page (repo `SimplementJohn/SimplementJohn`).

## Blocs actifs

| Section | Service | URL template |
|---|---|---|
...
**Tokyo Night** partout — `tokyonight` (stats) / `tokyo-night` (activity graph).
...
- `jj.png` — logo justejohn.fr
- `rackula.png` — logo projet Rackula
- `github.svg` — inutilisé

## Liens

- Profil : https://github.com/SimplementJohn
- Site : https://justejohn.fr
- LinkedIn : https://www.linkedin.com/in/john-rosa-38b0b1212/
